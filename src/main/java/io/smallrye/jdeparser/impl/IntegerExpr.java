 ...
 */
public final class IntegerExpr extends AbstractExpr {

    /** The integer literal {@code 0} in base 10. */
    public static final IntegerExpr ZERO = new IntegerExpr(0, 10);

    /** The integer literal {@code 1} in base 10. */
    public static final IntegerExpr ONE = new IntegerExpr(1, 10);
