...
public non-sealed class DocInlineCreatorImpl extends AbstractCreator implements DocInlineCreator, Writable {
    ...
    /** {@inheritDoc} */
    @Override
    public void link(final Type type) {
        checkActive();
    ...
    /** {@inheritDoc} */
    @Override
    public void link(final Type type, final String label) {
        checkActive();
        Assert.checkNotNullParam("type", type);
    ...
    /** {@inheritDoc} */
    @Override
    public void link(final DocReference ref) {
        checkActive();
    ...
    /** {@inheritDoc} */
    @Override
    public void link(final DocReference ref, final String label) {
        checkActive();
        Assert.checkNotNullParam("ref", ref);
        Assert.checkNotNullParam("label", label);
        final DocReferenceImpl impl = (DocReferenceImpl) ref;
    ...
    /** {@inheritDoc} */
    @Override
    public void linkPlain(final Type type) {
        checkActive();
        Assert.checkNotNullParam("type", type);
        registerUsedType(type);
        final String qualifiedName = typeName(type);
    ...
    /** {@inheritDoc} */
    @Override
    public void linkPlain(final Type type, final String label) {
        checkActive();
        Assert.checkNotNullParam("type", type);
        Assert.checkNotNullParam("label", label);
        registerUsedType(type);
    ...
    /** {@inheritDoc} */
    @Override
    public void linkPlain(final DocReference ref) {
        checkActive();
        Assert.checkNotNullParam("ref", ref);
        final DocReferenceImpl impl = (DocReferenceImpl) ref;
        if (impl.type() != null) {
    ...
    /** {@inheritDoc} */
    @Override
    public void linkPlain(final DocReference ref, final String label) {
        checkActive();
        Assert.checkNotNullParam("ref", ref);
        Assert.checkNotNullParam("label", label);
        final DocReferenceImpl impl = (DocReferenceImpl) ref;
    ...
    /** {@inheritDoc} */
    @Override
    public void inheritDoc(final Type supertype) {
        checkActive();
    ...
    /** {@inheritDoc} */
    @Override
    public void value(final DocReference ref) {
        checkActive();
        Assert.checkNotNullParam("ref", ref);
        final DocReferenceImpl impl = (DocReferenceImpl) ref;
        if (impl.type() != null) {
    ...
    /**
     * Extracts a type name string from a {@code Type} for use in doc comment text.
     *
     * @param type the type
