...
public final class AnnotationInterfaceCreatorImpl extends AbstractCreator implements AnnotationInterfaceCreator, Writable {
    ...
    /** {@inheritDoc} */
    @Override
    public void element(final String name, final Type type, final Expr defaultValue) {
        checkActive();
    ...
    /** {@inheritDoc} */
    @Override
    public void element(final String name, final Type type) {
        checkActive();
        Assert.checkNotNullParam("name", name);
        Assert.checkNotEmptyParam("name", name);
        Assert.checkNotNullParam("type", type);
    ...
    private record AnnotationElement(String name, Type type, Expr defaultValue) implements Writable {
        ...
        public void write(final SourceFileWriter writer) throws IOException {
            ...
            if (defaultValue != null) {
                ...
                AbstractExpr.writeExpr(writer, defaultValue);
            }
