 ...
 */
public final class KeywordExpr extends AbstractExpr {

    /** The {@code this} keyword expression. */
    public static final KeywordExpr THIS = new KeywordExpr(Tokens.$KW.THIS);

    /** The {@code super} keyword expression. */
    public static final KeywordExpr SUPER = new KeywordExpr(Tokens.$KW.SUPER);

    /** The {@code null} literal expression. */
    public static final KeywordExpr NULL = new KeywordExpr(Tokens.$KW.NULL);
     ...
     */
    private KeywordExpr(final Tokens.$KW token) {
        this.token = token;
    }
