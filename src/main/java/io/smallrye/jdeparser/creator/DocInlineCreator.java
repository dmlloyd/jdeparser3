...
public sealed interface DocInlineCreator permits DocCommentCreator, DocInlineCreatorImpl {
     ...
     */
    void inheritDoc(Type supertype);
     ...
     * <p>
     * Unlike {@link #link(Type)}, {@code {@linkplain}} renders
     * the label in plain text rather than code font.
     *
     * @param type the type to link to
     */
    void linkPlain(Type type);
     ...
     * <p>
     * Unlike {@link #link(DocReference)}, {@code {@linkplain}} renders
     * the label in plain text rather than code font.
     *
     * @param ref the program element reference
     */
    void linkPlain(DocReference ref);
     ...
     * <p>
     * Requires source version {@linkplain SourceVersion#JAVA_10 10}
     * or later.
     *
     ...
     * <p>
     * Requires source version {@linkplain SourceVersion#JAVA_12 12}
     * or later.
     *
